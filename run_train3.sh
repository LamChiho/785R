...
LAMBDA_PSL=0.5
SEED=1
VALUE_LR=1e-4  # Higher learning rate for value network

# Create checkpoints directory
mkdir -p ./checkpoints

echo "================================================================"
echo "NS-NLI Training with Learned Baseline + PSL"
echo "================================================================"
echo "Configuration:"
echo "  Batch Size: $BATCH_SIZE"
echo "  Policy Learning Rate: $LEARNING_RATE"
echo "  Value Learning Rate: $VALUE_LR"
...
# Run training with learned baseline and PSL
python train_baseline_psl.py \
    --use_psl \
    --use_baseline \
